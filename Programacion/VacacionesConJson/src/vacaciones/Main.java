...
public class Main {
    ...
    public static void main(String[] args) {
        ...
        do{
            ...
            System.out.println("6. Leer datos de archivo e introducirlos");
            entrada = sc.next();
            ...
            switch(entrada) {
                ...
                case "2":
                    ...
                    int cTelefono = Integer.parseInt(sc.nextLine());
                    
                    System.out.println("Edad de cliente");
                    int cEdad = Integer.parseInt(sc.nextLine());
                    ...
                    int cCliente = Integer.parseInt(sc.nextLine());
                ...
                case "5":
                    ...
                    //Abría que preguntar si nos han dado los datos del hotel. Pero ya los tenemos desde un principio
                    Gson gson = new Gson();
                    String hotelDatos = gson.toJson(h1);
                    
                    
                    ControladorFicheros.writeText(fileName, hotelDatos, true);
                    
                    break;
                case "6":
                    //Pedir datos de archivo
                    String fileName2 = "Hotel.txt";
                    String json = ControladorFicheros.readText(fileName2);
                    
                    Gson gson = new Gson();
                    h1 = gson.fromJson(json, Hotel.class);
                    break;
