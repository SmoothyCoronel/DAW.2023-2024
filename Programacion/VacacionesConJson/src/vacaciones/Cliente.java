...
public class Cliente {
    ...
    public String toString() {
        return "Cliente{" + "dni=" + dni + ", nombre=" + nombre + ", apellidos=" + apellidos + ", direccion=" + direccion + ", email=" + email + ", telefono=" + telefono + ", edad=" + edad 
                + ", fechaNacimiento=" + fechaNacimiento + ", pago=" + pago + '}';
    }
