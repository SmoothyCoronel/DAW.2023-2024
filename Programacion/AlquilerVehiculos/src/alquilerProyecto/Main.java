...
public class Main {
    ...
    private static String op, s1, s2, s3, s10, s9;
    ...
    public static void main(String[] args) {
        ...
        Vehiculo coche1 = new Coche("22", "Corsa", "Opel", 50000, 50, TipoMotor.GASOLINA, 5, 5, 300, TipoCoche.UTILITARIO);
        Vehiculo coche2 = new Coche("5678XYZ", "Astra", "Opel", 70000, 60, TipoMotor.DIESEL, 5, 5, 350, TipoCoche.UTILITARIO);
        Vehiculo coche3 = new Coche("9876ZYX", "Golf", "Volkswagen", 60000, 70, TipoMotor.ELECTRICO, 5, 5, 320, TipoCoche.BERLINA);
        Vehiculo coche4 = new Coche("4321CBA", "Civic", "Honda", 80000, 65, TipoMotor.HIBRIDO, 5, 5, 310, TipoCoche.SUV);
        Vehiculo coche5 = new Coche("2468DFG", "3 Series", "BMW", 55000, 80, TipoMotor.GASOLINA, 5, 5, 330, TipoCoche.MONOVOLUMEN);
        e.addVehiculo(coche1);
        e.addVehiculo(coche2);
        e.addVehiculo(coche3);
        e.addVehiculo(coche4);
        e.addVehiculo(coche5);
        Vehiculo furgon1 = new Furgon("1111AAA", "Transit", "Ford", 100000, 80, TipoMotor.DIESEL, 1500, 3);
        Vehiculo furgon2 = new Furgon("2222BBB", "Boxer", "Peugeot", 90000, 75, TipoMotor.GASOLINA, 1800, 2);
        Vehiculo furgon3 = new Furgon("3333CCC", "Sprinter", "Mercedes-Benz", 120000, 90, TipoMotor.ELECTRICO, 2000, 2);
        Vehiculo furgon4 = new Furgon("4444DDD", "Ducato", "Fiat", 95000, 70, TipoMotor.DIESEL, 1700, 2);
        Vehiculo furgon5 = new Furgon("5555EEE", "Jumper", "Citroen", 110000, 85, TipoMotor.HIBRIDO, 1900, 3);
        e.addVehiculo(furgon1);
        e.addVehiculo(furgon2);
        e.addVehiculo(furgon3);
        e.addVehiculo(furgon4);
        e.addVehiculo(furgon5);
        Vehiculo camion1 = new Camion("6666TTT", "FH16", "Volvo", 200000, 150, TipoMotor.DIESEL, 20000, 10);
        Vehiculo camion2 = new Camion("6789CVC", "Actros", "Mercedes-Benz", 180000, 140, TipoMotor.GASOLINA, 18000, 9);
        Vehiculo camion3 = new Camion("6768CFH", "Stralis", "Iveco", 220000, 160, TipoMotor.DIESEL, 22000, 11);
        Vehiculo camion4 = new Camion("4509BNM", "TGS", "MAN", 190000, 145, TipoMotor.HIBRIDO, 19000, 9);
        Vehiculo camion5 = new Camion("6542GYZ", "Quon", "UD Trucks", 210000, 155, TipoMotor.ELECTRICO, 21000, 12);
        ...
        while (continuar) {
            ...
            switch (teclado) {
                ...
                case 3:
                    ...
                    alquilarVehiculo();
                    VehiculosAlquilados a = new VehiculosAlquilados(fechaInicio, s6, e.existeCliente(s1), e.existeVehiculo(op));
                    e.alquilarVehiculoCliente(a);
                ...
                case 5:
                    ...
                    precioAPagar();
                    float precioFinal = e.price(e.existeCliente(s3), e.existeVehiculo(op), s6);
    ...
    private static Cliente nuevoCLiente() {
        ...
        nuevoCliente = new Cliente(op, s1, s2, s3, s9, s10);
        return nuevoCliente;
    }
